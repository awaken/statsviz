...
<i>assist is</i> the rate of change, per second, of <b>/cpu/classes/scavenge/assist:cpu-seconds</b>, the CPU time spent returning unused memory eagerly in response to memory pressure.
<i>background is</i> the rate of change, per second, of <b>/cpu/classes/scavenge/background:cpu-seconds</b>, the CPU time spent performing background tasks to return unused memory to the OS.
