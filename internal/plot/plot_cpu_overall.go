...
<i>scavenge is</i> the rate of change, per second, of <b>/cpu/classes/scavenge/total:cpu-seconds</b>, the CPU time spent performing tasks that return unused memory to the underlying platform.
<i>idle is</i> the rate of change, per second, of <b>/cpu/classes/idle:cpu-seconds</b>, the available CPU time not spent executing any Go or Go runtime code.
